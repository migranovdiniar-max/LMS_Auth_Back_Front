...
# Вывод
Проект демонстрирует полностью собственную систему аутентификации и RBAC без использования встроенных механизмов Django Auth. Было реализовано backend-приложение – собственную систему аутентификации и авторизации. Продемонстрировано умение работы с DRF в связке с React. Реализовать минимальные вымышленные объекты бизнес-приложения, к которым могла бы применяться созданная система.
